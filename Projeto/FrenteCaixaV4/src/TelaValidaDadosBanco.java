...
public class TelaValidaDadosBanco extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("LIFES CREATIVE - Configuração do MySQL");
        setResizable(false);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTFHost, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel11, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(10, 10, 10)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jTFBD, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jBSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBSalvarActionPerformed
        ...
        if (host.equals("") || BD.equals("") || user.equals("") || senha.equals("")) {
            JOptionPane.showMessageDialog(null, "Por favor, preencha todos os campos", "LIFES CREATIVE - Configuração do Banco de Dados", JOptionPane.ERROR_MESSAGE);
            ...
            try {
                ...
                bw.write(host + "\r\n" + BD + "\r\n" + user + "\r\n" + senha);
                bw.close();
                JOptionPane.showMessageDialog(null, "Dados gravados com sucesso", "LIFES CREATIVE - Configuração do Banco de Dados", JOptionPane.INFORMATION_MESSAGE);
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(null, "Erro ao salvar os dados", "LIFES CREATIVE - Configuração do Banco de Dados", JOptionPane.ERROR_MESSAGE);
                Logger.getLogger(TelaValidaDadosBanco.class.getName()).log(Level.SEVERE, null, ex);
            }
            dispose();
            try {
